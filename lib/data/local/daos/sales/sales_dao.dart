...
class SalesDao extends DatabaseAccessor<AppDatabase> with _$SalesDaoMixin {
  ...
  int get userId => LocalStorage.getInt('userId') ?? 0;
  ...
  // Get Sale By Id
  Future<Sale?> getById(int id) => (select(sales)..where((s) => s.id.equals(id))).getSingleOrNull();

  // Get Sale By User
  Future<Sale?> getByUserId(int userId) => (select(sales)..where((s) => s.userId.equals(userId))).getSingleOrNull();
